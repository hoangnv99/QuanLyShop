...
namespace QuanLyShop.Controllers
{
    public class KHACHHANGsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaKH,HoTen,NgaySinh,GioiTinh,SoDienThoai,DiaChi")] KHACHHANG kHACHHANG)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaKH,HoTen,NgaySinh,GioiTinh,SoDienThoai,DiaChi")] KHACHHANG kHACHHANG)
        {
            if (ModelState.IsValid)
            {
